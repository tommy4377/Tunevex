<script lang="ts">
    ...
    const allPrograms: Program[] = [
        ...
        },
        {
            id: "GOG.Galaxy",
            name: "GOG Galaxy",
            description: "Gaming client for DRM-free games.",
            category: "Games",
        },
        {
            id: "RiotGames.LeagueOfLegends.NA",
        ...
        },
        {
            ...
            name: "Playnite",
            description: "Open source game library manager.",
            category: "Games",
        },
        {
            id: "ProtonVPN.ProtonVPN",
            name: "ProtonVPN",
        ...
        },
        {
            id: "REALiX.HWiNFO",
            name: "HWiNFO",
            description: "Detailed system hardware analysis.",
            category: "Utilities",
        },
        {
            id: "TechPowerUp.GPU-Z",
            name: "GPU-Z",
            description: "GPU information utility.",
            category: "Utilities",
        },
        {
            id: "CPUID.HWMonitor",
        ...
        },
        {
            id: "ShareX.ShareX",
            name: "ShareX",
            description: "Screen capture and sharing tool.",
            category: "Multimedia",
        },
        {
        ...
        },
        {
            ...
            name: "mRemoteNG",
            description: "Multi-protocol remote connections manager.",
            category: "Utilities",
        },
        {
            id: "WinSCP.WinSCP",
            name: "WinSCP",
            description: "SFTP, SCP, FTP client.",
            category: "Utilities",
        },
        {
            id: "PuTTY.PuTTY",
